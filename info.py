...
API_ID = int(environ('API_ID','28351671'))
API_HASH = environ('API_HASH', '0452639d24224cc883f339792aa3ded6')
BOT_TOKEN = environ('BOT_TOKEN', '6154753189:AAGRY_Mj5Pbkkb8gtqIEo0ae4TJStbSDWPQ')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5472700485').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001889921538').split()]
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001813992115)
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
NO_RESULTS_MSG = bool(environ.get("NO_RESULTS_MSG", False))

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://koriraja750:koriraja1234@cluster0.ni8k5vd.mongodb.net/?retryWrites=true&w=majority")
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1001901263852').split()]
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001850169554'))
